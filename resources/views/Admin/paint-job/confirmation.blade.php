        ...
        <table id="dtHorizontalExample" class="table table-condensed table-hover" cellspacing="0" width="100%" >
          <thead class="table-success">
            <tr>
              ...
              <th scope="col" class="align-middle text-center">Reject</th>
              <th scope="col" class="align-middle text-center">Accept</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td>GLX Plus</td>
              <td>APR-11-2023</td>
              <td class="text-center"><spantype="button" class="btn btn-primary"><i class="fa-solid fa-image"></i></span></td>
              <td class="text-center"><spantype="button" class="btn btn-danger"><i class="fa-solid fa-xmark"></i></span></td>
              <td class="text-center"><spantype="button" class="btn btn-success"><i class="fa-solid fa-check"></i></span></td>
            </tr>
            <tr>
