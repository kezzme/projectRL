...
<div class="container-fluid bg-secondary finCal my-5 wow fadeInUp" data-wow-delay="0.1s">
  ...
  <div class="col-12">
            ...
            <button class="btn btn-secondary btn-rounded w-100" type="button" style="height: 45px;" onclick="calculate()">Calculate</a></button>
    ...
    <div class="row gx-5">
      <div class="col-lg-6 py-5">
        <div class="py-5">
          ...
          <p class="text-white mb-0" style="font-size:x-large;">
          The computation here is based on interest rate. Interest rates may differ depending on the loan provider (bank or in-house). 
          The amounts listed don't represent any offer from RL Car Dealer or any of its Financing Partners.
          </p>
        </div>
      </div>
      <div class="col-lg-6">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Minimum down payment is 30% of the total price.
                </div>
