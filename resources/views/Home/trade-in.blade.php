...
<!-- Page Header Start -->
<div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-10.jpg);">
          ...
          <form>
            <div class="row g-3">
              <div class="col-12 col-sm-6">
                <input type="text" class="form-control btn-rounded" placeholder="First Name" style="height: 50px;">
              </div>
              <div class="col-12 col-sm-6">
                <input type="text" class="form-control btn-rounded" placeholder="Last Name" style="height: 50px;">
              </div>
              <div class="col-12 col-sm-4">
                <input type="text" class="form-control btn-rounded" placeholder="Phone No." style="height: 50px;">
              </div>
              <div class="col-12 col-sm-4">
                <div class=" input-group">
                  <div class="col-md-5 input-group-text justify-content-center btn-rounded">Year</div>
                  <input type="text" class="form-control btn-rounded" style="height: 50px; text-transform:uppercase;">
                </div>
              </div>
              <div class="col-12 col-sm-4">
                <div class=" input-group">
              ...
              <div class="col-12 col-sm-6">
                <div class=" input-group">
                  ...
                  <input type="text" class="form-control btn-rounded" style="height: 40px; text-transform:uppercase;">
                </div>
              </div>
